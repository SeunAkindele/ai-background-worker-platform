...
class RecommendationHandler(BaseJobHandler[dict[str, Any], dict[str, Any]]):
    ...
    def process(self, input_payload: dict[str, Any]) -> dict[str, Any]:
        """Produce top-k collaborative filtering recommendations for a user."""
    ...
    def _build_graph(
        ...
        """Build user↔item adjacency lists and rating edge weights."""
    ...
    def _find_similar_users(
        ...
        """Score similar users by Jaccard overlap of interacted items."""
    ...
    def _score_candidates(
        ...
        """Score unseen items from similar users' ratings."""
