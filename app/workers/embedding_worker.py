"""Embedding handler — text vectors, cosine similarity, nearest-neighbor lookup."""
import math
...
class EmbeddingHandler(BaseJobHandler[dict[str, Any], dict[str, Any]]):
    """Generates text embeddings; optionally compares or finds nearest neighbors."""
    ...
    def process(self, input_payload: dict[str, Any]) -> dict[str, Any]:
        """Encode text(s); optionally compute similarity or nearest neighbor."""
    ...
    def _cosine_similarity(vec_a: list[float], vec_b: list[float]) -> float:
        """Cosine similarity between two vectors; range is -1 to 1."""
    ...
    def _find_nearest(
        ...
        """Return the index and score of the most similar candidate vector."""
        best_idx = 0
        best_score = -1.0
