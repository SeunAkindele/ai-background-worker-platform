"""Embedding worker: text vectors, similarity, and nearest-neighbor lookup."""
import math
...
class EmbeddingHandler(BaseJobHandler[dict[str, Any], dict[str, Any]]):
    """Generates text embeddings; optionally compares or finds nearest matches."""
    ...
    def _find_nearest(
        ...
        """Return index and score of the candidate most similar to query."""
        best_idx = 0
        best_score = -1.0
