...
class HeartbeatService:
    ...
    def _upsert(
        ...
        *,
        ...
        When update_type/update_status are False (pulse), only last_seen_at
        is refreshed so status and job fields stay intact.
        """
        existing = (
    ...
    def mark_stale_workers_offline(self, db: Session) -> int:
        """Mark workers offline if their last heartbeat is older than HEARTBEAT_TIMEOUT."""
