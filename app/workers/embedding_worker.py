...
class EmbeddingHandler(BaseJobHandler[dict[str, Any], dict[str, Any]]):
    """
    Generate text embeddings. Optionally compute cosine similarity
    or find the nearest text in a batch.
    """
    ...
    def _find_nearest(
        ...
        """Return index and score of the most similar candidate vector."""
        best_idx = 0
        best_score = -1.0
