"""Recommendation handler — collaborative filtering over user-item interactions."""
import heapq
...
class RecommendationHandler(BaseJobHandler[dict[str, Any], dict[str, Any]]):
    """
    Collaborative filtering recommendations from a bipartite user-item graph.

    Builds user/item adjacency, finds similar users, scores unseen items,
    and returns Top-K recommendations.
    """
    ...
    def process(self, input_payload: dict[str, Any]) -> dict[str, Any]:
        """Score and return Top-K item recommendations for the target user."""
    ...
    def _find_similar_users(
        ...
        """Score similar users by Jaccard overlap of shared items."""
    ...
    def _score_candidates(
        ...
        """Score unseen items from similar users' preferences."""
