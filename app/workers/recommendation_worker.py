...
class RecommendationHandler(BaseJobHandler[dict[str, Any], dict[str, Any]]):
    """Scores unseen items from similar users and returns Top-K recommendations."""
    ...
    def process(self, input_payload: dict[str, Any]) -> dict[str, Any]:
        """Build interaction graph, find similar users, score and rank candidates."""
    ...
    def _find_similar_users(
        ...
        """Score users who share items with the target (Jaccard-like)."""
    ...
    def _score_candidates(
        ...
        """Score unseen items using similar users' ratings weighted by similarity."""
