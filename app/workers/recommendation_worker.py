...
class RecommendationHandler(BaseJobHandler[dict[str, Any], dict[str, Any]]):
    ...
    Builds a bipartite user–item graph, finds similar users, scores unseen
    items, and returns Top-K recommendations.
    """
    ...
    def _build_graph(
        ...
        """Build user→items, item→users adjacency lists and rating weights."""
    ...
    def _find_similar_users(
        ...
        """Score similar users by Jaccard overlap on shared items."""
    ...
    def _score_candidates(
        ...
        """Weight unseen items by similar users' ratings."""
