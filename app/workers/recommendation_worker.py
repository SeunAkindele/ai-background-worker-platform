"""Recommendation worker — collaborative filtering over user-item interactions."""
import heapq
...
class RecommendationHandler(BaseJobHandler[dict[str, Any], dict[str, Any]]):
    """Recommend items by finding similar users and scoring their unseen items."""
    ...
    def process(self, input_payload: dict[str, Any]) -> dict[str, Any]:
        """Build the interaction graph, find similar users, and return top-K items."""
    ...
    def _build_graph(
        ...
        """Build user→items, item→users, and per-user rating maps."""
    ...
    def _find_similar_users(
        ...
        """Score other users by Jaccard overlap of shared items."""
    ...
    def _score_candidates(
        ...
        """Weight unseen items by similar-user similarity × rating."""
