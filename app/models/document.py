"""RAG data models: Document → Chunk → ChunkEmbedding."""
import enum
import uuid
...
class Document(Base):
    ...
    # JSONB metadata for filtering; attribute is metadata_ because
...
class Chunk(Base):
    ...
    level: Mapped[str] = mapped_column(Text, nullable=False, default="child")
